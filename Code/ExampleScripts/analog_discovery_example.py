...
if __name__ == '__main__':
    ...
    WF_SDK.wavegen.generate(device_data, channel=1, function=WF_SDK.wavegen.function.sine, offset=0, frequency=10e03, amplitude=2)

    data = scope_time_capture(device_data, channel=1, run_time=1)
